...
using Chatinbox.ChatAnalysis.Tests.Fixtures;

namespace Chatinbox.ChatAnalysis.Tests.IntegrationTests;
...
public class HealthEndpointTests : IClassFixture<ChatAnalysisWebApplicationFactory>
{
    ...
    public async Task Health_ReturnsValidJson()
    {
        ...
        json.RootElement.GetProperty("service").GetString().Should().Be("Chatinbox.ChatAnalysis");
