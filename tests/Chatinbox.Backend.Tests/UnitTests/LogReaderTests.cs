...
namespace Chatinbox.Backend.Tests.UnitTests;
...
public class LogReaderTests
{
    ...
    {
        // Arrange
        var logFile = Path.Combine(_testLogDir, $"Chatinbox.Backend-{DateTime.UtcNow:yyyyMMdd}.jsonl");
        var logEntry = """{"ts":"2026-02-03T10:00:00Z","level":"INFO","msg":"Test message","service":"Chatinbox.Backend"}""";
    ...
    public async Task QueryLogsAsync_WithLevelFilter_FiltersCorrectly()
    {
        ...
        {
            """{"ts":"2026-02-03T10:00:00Z","level":"INFO","msg":"Info message","service":"Chatinbox.Backend"}""",
            """{"ts":"2026-02-03T10:00:01Z","level":"ERROR","msg":"Error message","service":"Chatinbox.Backend"}""",
            """{"ts":"2026-02-03T10:00:02Z","level":"WARN","msg":"Warn message","service":"Chatinbox.Backend"}"""
        });
    ...
    public async Task GetLastErrorsAsync_WithErrorLogs_ReturnsErrors()
    {
        ...
        {
            """{"ts":"2026-02-03T10:00:00Z","level":"INFO","msg":"Info message","service":"Chatinbox.Backend"}""",
            """{"ts":"2026-02-03T10:00:01Z","level":"ERROR","msg":"Error 1","service":"Chatinbox.Backend"}""",
            """{"ts":"2026-02-03T10:00:02Z","level":"ERROR","msg":"Error 2","service":"Chatinbox.Backend"}"""
        });
        await File.WriteAllTextAsync(logFile, logs + Environment.NewLine);
