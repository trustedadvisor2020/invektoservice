...
> **Durum:** IN PROGRESS (PR-1/PR-2/PR-3a DONE; PR-3b BLOCKED-G12; PR-4 + PKT-2 TODO) · **Oluşturma:** 2026-06-06 · **Sahip:** Q
...
| **PKT-2** | `2026xxxx-projeler-*` | `projects` tablosu (**migration 057** — 056 PR-3a'ya gitti) + CRUD + Projeler sayfası/wizard (TONIVA mode4 benzeri) + cxapi template-list endpoint + Backend proxy + UI. | HIGH | TODO |
