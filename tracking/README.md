...
| FEAT-PROJELER | cxapi Send Engine + Projeler | INSE bulk WA → doğrudan cxapi /chatoperation taşıma (4-PR send engine) + TONIVA mode4 benzeri "Projeler" yönetim katmanı (PKT-14, 4 slice). cxapi: PR-1/2/3a/**3b** DONE (prod INERT, default-OFF; G12 ✅ çözüldü) · PR-4 TODO. Projeler PKT-14: **S1-S4 ✅ DONE+DEPLOYED 2026-06-07** (migration 055-057 canlı) · **send-exec SS-A/B/C ✅ DONE+DEPLOYED 2026-06-09** (migration 059+060; inline-text + içerik config + run dispatch + Gönder UI) · **SS-D pause/resume/cancel ✅ DONE+COMMITTED 2026-06-09 `c98b03fc` — ⚠️ DEPLOY PENDING (migration 061 prod'da yok; ÖNCE migration, sonra Outbound+Backend+SPA)**. ⛔ LIVE-ENABLEMENT GATE P0-3 aktif. | [Roadmap](feat-projeler-cxapi-roadmap.md) / [SS-D Plan](../arch/plans/20260610-projeler-ssd-pause-cancel.json) | S1-S4: 7 Haz · SS-A/B/C: 9 Haz · SS-D: 9 Haz (deploy pending) · cxapi: 6-8 Haz | S1 iter0 · S2 iter4 · S3 iter1 · S4 iter0 · SS-A iter1 · SS-B iter0 · SS-C iter3 · **SS-D iter1 + Q FORCE PASS CQ9** · PR-3a Q FORCE PASS · PR-3b iter0/iter2 · PR-1 iter3 · PR-2 iter0 |
