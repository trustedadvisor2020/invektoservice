...
| FEAT-IYS-INTEGRATION | İYS (İleti Yönetim Sistemi) Entegrasyonu — tenant markaları adına ticari ileti izin yönetimi | Direkt bağlanma (Invekto = yetkili AHS/Entegratör). 3 kanal (ARAMA/MESAJ/EPOSTA; WhatsApp pratikte MESAJ). OAuth2 client_credentials + tekil/çoklu izin ekleme+sorgulama + 3-iş-günü SLA job. Multi-tenant: her tenant ayrı HS/marka + ayrı marka paketi. `InvektoIys` servis/modül + 3 DB tablo (iys_integrations/iys_consents/iys_events) + cxapi gönderim-öncesi gate + INV-IYS-* error namespace. **#1 karar: AHS mi / Entegratör yetkisi mi (İYS A.Ş. teyidi).** MVP=önce sorgu. İYS≠KVKK. | [Detay](feat-iys-integration.md) | **DRAFT-RESEARCH** (2026-06-13) — Build BLOCKED: Faz 0 statü cevabı (İYS A.Ş.) bekliyor | 13 Haz | - |
...
**Toplam:** 55 paket (28 done, 0 in-progress, 5 planned, 3 pending, 13 feature DRAFT/SPEC, 1 pilot blocked, 0 active customer, 3 backlog, 2 cancelled) | 50+ GR + RI-100+ task
