...
| FEAT-PROJELER | cxapi Send Engine + Projeler | INSE bulk WA → doğrudan cxapi /chatoperation taşıma (4-PR send engine) + TONIVA mode4 benzeri "Projeler" yönetim katmanı (PKT-14, 4 slice). cxapi: PR-1/PR-2/PR-3a DONE (prod INERT, default-OFF) · PR-3b BLOCKED-G12 · PR-4 TODO. Projeler PKT-14: **S1 ✅ DONE** (migration 057 projects+project_targets+bulk_send_jobs.project_id, full parent model, canonical sync, INV-SEED-057) · S2 CRUD / S3 cxapi template-list / S4 React UI TODO. ⛔ LIVE-ENABLEMENT GATE P0-3 aktif. | [Roadmap](feat-projeler-cxapi-roadmap.md) / [S1 Plan](../arch/plans/20260607-projeler-s1-schema.json) | S1: 7 Haz · cxapi: 6-7 Haz | **S1 iter 0 PASS** (12/12 CQ + 4/4 CoVe) · PR-3a Q FORCE PASS · PR-1 iter3 · PR-2 iter0 |
