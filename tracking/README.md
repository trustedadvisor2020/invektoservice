...
| FEAT-LIW | Lead Intake Webhook | Chunk A: Generic POST /leads/intake + field map + dup merge. Chunk B: TriggerWelcomeFlowJob real dispatch + /api/internal/leads/intake/wa-direct + AutomationOrchestrator hook. | [Spec](../arch/features/lead-intake-webhook.md) | A DONE + B DONE (Q FORCE PASS), Chunk C UI bekliyor; deploy A+B atomik bekliyor | 18 Nis | A iter 4 PASS / B iter 3 → Q FORCE PASS |
