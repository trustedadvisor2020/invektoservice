...
| Metric | Value |
|--------|-------|
| Total Pilot-Critical Packages | 13 (P10 P9-escalation 2026-04-22 + P11 post-P9 wiring 2026-04-22 + Paket A 2026-04-24 + **Paket B B-VCP-DOCTORS PROMOTED 2026-04-24**) |
...
| IN_PROGRESS | 1 (**Paket B B-VCP-DOCTORS Doctors Table Bootstrap 2026-04-24 14:45 UTC** — Codex review pending, migration not yet executed) |
| PENDING | 0 |
| SKIPPED | 0 |
| Progress | 92% pilot-critical paketler (12/13 DONE + 1 IN_PROGRESS Paket B); pilot go-live için Paket B smoke + sonra Paket C (template content bind 46 welcome + 36 FAQ). |
| Backlog Packages | 6 (B0/B1/B2/B3/B4/B5 — B-VCP-DOCTORS PROMOTED to Master Queue Paket B) |
