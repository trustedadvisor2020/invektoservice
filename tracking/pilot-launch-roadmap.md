...
| Metric | Value |
|--------|-------|
| Total Pilot-Critical Packages | 13 (P10 P9-escalation 2026-04-22 + P11 post-P9 wiring 2026-04-22 + Paket A 2026-04-24 + Paket B B-VCP-DOCTORS 2026-04-24) |
| DONE | 13 (P1-P6 DEPLOYED+SMOKED; P7 retroactive; P8 prod file op; P9 DONE+SMOKED_PARTIAL; P10 EFS Hangfire fix; P11 FlowBuilder wiring; A Dent plan_tier upgrade 2026-04-24 11:25 UTC; **B B-VCP-DOCTORS Doctors Bootstrap 2026-04-24 12:20 UTC DONE+DEPLOYED+SMOKED**) |
| IN_PROGRESS | 0 |
| PENDING | 0 |
| SKIPPED | 0 |
| Progress | **100% pilot-critical paketler (13/13)**; pilot go-live için sıradaki: Paket C (template content bind 46 welcome + 36 FAQ placeholder → DocX real content + faq_entries.is_active=TRUE flip + chatbot_flows.flow_config.nodes[].data.text update + S4 AI FAQ translation hop smoke). |
| Backlog Packages | 6 (B0/B1/B2/B3/B4/B5 — B-VCP-DOCTORS PROMOTED to Paket B + closed 2026-04-24) |
