...
| DONE | 13 (P1-P6 DEPLOYED+SMOKED; P7 retroactive; P8 prod file op; P9 DONE+SMOKED_PARTIAL; P10 EFS Hangfire fix; P11 FlowBuilder wiring; A Dent plan_tier upgrade; B B-VCP-DOCTORS Doctors Bootstrap) |
| IN_PROGRESS | 1 (Paket C1 Codex review queue MEDIUM risk, 5-surprise discovery + Q tek-shot scope split) |
| PENDING | 0 |
| SKIPPED | 0 |
| Progress | **93% pilot-critical paketler (13/14)**; sıradaki: Paket C1 Codex iter=0 PASS (CODEX UTANSIN) → prod execute Migration 032 → embeddings POST → S4 smoke → roadmap finalize. C2 (welcome overhaul post-pilot) BACKLOG. |
