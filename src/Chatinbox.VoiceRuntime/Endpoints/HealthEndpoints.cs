...
public static class HealthEndpoints
{
    public static void MapHealthEndpoints(this WebApplication app)
    {
        ...
        app.MapGet("/health", () => Results.Ok(HealthResponse.Ok("Chatinbox.VoiceRuntime")));
        ...
        app.MapGet("/ready", (IConfiguration config) =>
        {
            ...
            return missing.Count == 0
                ? Results.Ok(new { status = "ready", service = "Chatinbox.VoiceRuntime" })
                : Results.Json(new { status = "degraded", service = "Chatinbox.VoiceRuntime", missing }, statusCode: 200);
        });
    }
}
