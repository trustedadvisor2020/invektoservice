...
/// Implementations live in Chatinbox.Integrations (Chunk A: GoogleMeetMockProvider;
/// Chunk C: GoogleMeetProvider with Workspace OAuth). Callers (Chatinbox.Appointments
