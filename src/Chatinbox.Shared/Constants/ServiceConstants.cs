...
public static class ServiceConstants
{
    ...
    // Service names
    public const string BackendServiceName = "Chatinbox.Backend";
    public const string ChatAnalysisServiceName = "Chatinbox.ChatAnalysis";
    // Phase 1 service names (reserved)
    public const string AgentAIServiceName = "Chatinbox.AgentAI";
    public const string OutboundServiceName = "Chatinbox.Outbound";
    public const string AutomationServiceName = "Chatinbox.Automation";
    public const string IntegrationsServiceName = "Chatinbox.Integrations";
    // Phase 2 service names
    public const string AppointmentsServiceName = "Chatinbox.Appointments";
    public const string KnowledgeServiceName = "Chatinbox.Knowledge";
    public const string WhatsAppAnalyticsServiceName = "Chatinbox.WhatsAppAnalytics";
    // Phase 3B service names
    public const string MarketingServiceName = "Chatinbox.Marketing";
    // WebChat service name
    public const string WebChatServiceName = "Chatinbox.WebChat";
    // VoiceAI service name
    public const string VoiceAIServiceName = "Chatinbox.VoiceAI";
