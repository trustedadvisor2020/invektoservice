...
import { RefreshCw, Power, Globe, Link2, Server, MessageSquare, X, ExternalLink, List } from 'lucide-react';
...
// Service configuration with icons and endpoints
const serviceConfig: Record<string, {
  ...
  'Invekto.Backend': {
    ...
    endpoints: [
      ...
      { method: 'GET', path: '/ops', description: 'Operations dashboard' },
      { method: 'GET', path: '/api/ops/health', description: 'All services health' },
      { method: 'GET', path: '/api/ops/logs/stream', description: 'Log stream with filters' },
      { method: 'GET', path: '/api/ops/logs/context', description: 'Log context (±10 lines)' },
      { method: 'GET', path: '/api/ops/stats/errors', description: 'Error statistics (24h)' },
      { method: 'POST', path: '/api/ops/services/{name}/restart', description: 'Restart service' },
    ],
  },
  'Invekto.ChatAnalysis': {
    ...
    endpoints: [
      { method: 'GET', path: '/health', description: 'Health check' },
      { method: 'POST', path: '/api/analyze', description: 'Analyze chat message' },
    ],
  },
};
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-gray-500">Port {config.port}</span>
              </div>
            </div>
