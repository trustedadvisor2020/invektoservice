...
///   1. Invekto.Automation.Resources.IntentPrompts.{locale}.json
///   2. Invekto.Automation.Resources.IntentPrompts.tr.json (pre-HFM-2 default)
///
...
public sealed class IntentPromptLoader
{
    ...
    private const string ResourcePrefix = "Invekto.Automation.Resources.IntentPrompts.";
