...
public sealed class FollowupSequenceCache
{
    ...
    private async Task<FollowupSequenceConfig?> RunFetchAsync(CacheKey key)
    {
        ...
        catch (Npgsql.NpgsqlException ex)
        {
            ...
            _log.SystemWarn(
                $"[{Invekto.Shared.Constants.ErrorCodes.FollowupStorageUnavailable}] FollowupSequenceCache: " +
        ...
        catch (System.Text.Json.JsonException ex)
        {
            ...
            _log.SystemWarn(
                $"[{Invekto.Shared.Constants.ErrorCodes.FollowupSequenceConfigInvalid}] FollowupSequenceCache: " +
