...
namespace Chatinbox.Knowledge.Data;
...
public class KnowledgeRepository
{
    ...
    public virtual async Task<int> SeedTenantIntentsFromSectorAsync(int tenantId, string sector, CancellationToken ct = default)
    {
        ...
        {
            _logger.SystemWarn($"[{Chatinbox.Shared.Constants.ErrorCodes.KnowledgeIntentPatternsNotFound}] No sector templates found for sector '{sector}'");
            return 0;
        }
