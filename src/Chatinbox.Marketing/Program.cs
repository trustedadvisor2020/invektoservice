...
using Chatinbox.Marketing.Endpoints;
using Chatinbox.Marketing.Services;
using Chatinbox.Marketing.Services.Jobs;
...
// (see Chatinbox.Shared.Hosting.HangfireSetup). Queue name 'marketing-followup' isolates
