...
using System.Text;
using Chatinbox.Integrations.Services.Video;
using Chatinbox.Shared.Contracts.Video;
using Chatinbox.Shared.Logging;
using Npgsql;

namespace Chatinbox.Integrations.Endpoints;

/// <summary>
/// FEAT-VCP Chunk B: internal endpoint consumed by Chatinbox.Appointments'
