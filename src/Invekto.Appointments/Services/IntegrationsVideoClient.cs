...
/// <summary>
/// FEAT-VCP Chunk B: HTTP hop from Invekto.Appointments' VideoMeetingCreationJob to
/// Invekto.Integrations' <c>POST /internal/video/meetings</c>. Preserves the three
...
/// Microservice isolation: no <c>using Invekto.Integrations</c>; contracts and envelopes
/// come from <c>Invekto.Shared.Contracts.Video</c>.
/// </summary>
