...
| **§4 sector_adapter** | ❌ YOK — sector sadece prompt'a string olarak giriyor (F-VR-B B2) | vocabulary / intent priority / banned_words / required_fields per-sector katmanı yok — B2: `SectorAdapter` registry (6 adapter: clinic/dental_clinic/aesthetic_clinic/hair_transplant/ecommerce/generic) VoiceRuntime'da kod-versiyonlu |
