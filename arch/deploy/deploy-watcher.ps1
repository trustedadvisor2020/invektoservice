...
$watchPath = "E:\Invekto"
$nssm = "E:\nssm.exe"
$services = @("InvektoBackend", "InvektoChatAnalysis", "InvektoAutomation", "InvektoAgentAI", "InvektoOutbound", "InvektoKnowledge", "InvektoAppointments", "InvektoIntegrations", "InvektoWhatsAppAnalytics")
