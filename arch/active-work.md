...
| 3 | Welcome endpoint JSON fix | PENDING | Plain text "Merhaba 5050" → JSON |
| 4 | InmaJwtValidator CompanyCode alignment | PENDING | Validated path CompanyId→CompanyCode |
| 5 | Template ingestion E2E test | PENDING | Ebrumoda verisi ile extraction |
