        ...
        <div className="max-w-[1700px] mx-auto p-10 font-sans bg-gray-50/50 min-h-screen">
            ...
            <div className="mt-16">
                <FlatCard className="bg-emerald-50/80 border-emerald-100">
                    <div className="mb-8">
                        <h2 className="text-3xl font-bold text-emerald-900 mb-2">Potansiyel Aylık Etki: ~144.000 TL</h2>
                        <p className="text-emerald-700 text-lg">
                            Bu hesaplama, e-ticaret istatistiklerine göre <strong>1 negatif yorumun, potansiyel 4 yeni müşteriyi kaçırdığı</strong> varsayımıyla yapılmıştır.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pt-8 border-t border-emerald-200">
                        <div>
                            ...
                            <span className="block text-3xl font-bold text-emerald-900">200+</span>
                            <span className="text-emerald-700/80 text-sm mt-1 block">Ortalama kargo sayısı</span>
                        </div>

                        <div>
                            <span className="block text-emerald-600 text-sm font-bold uppercase tracking-wide mb-1">Negatif Yorum (Gün)</span>
                            <span className="block text-3xl font-bold text-emerald-900">1 Adet</span>
                            <span className="text-emerald-700/80 text-sm mt-1 block text-sm">%0.5 hata payı ile</span>
                        </div>

                        <div>
                            <span className="block text-emerald-600 text-sm font-bold uppercase tracking-wide mb-1">Etkilenen Müşteri</span>
                            <span className="block text-3xl font-bold text-emerald-900">4 Kişi</span>
                            <span className="text-emerald-700/80 text-sm mt-1 block">1 Yorumun etkilediği</span>
                        </div>

                        <div>
                            <span className="block text-emerald-600 text-sm font-bold uppercase tracking-wide mb-1">Korunan Ciro (Aylık)</span>
                            <span className="block text-3xl font-bold text-emerald-900">144k ₺</span>
                            <span className="text-emerald-700/80 text-sm mt-1 block">1.200₺ Sepet Ort.</span>
                        </div>
                    </div>
                </FlatCard>
            </div>
